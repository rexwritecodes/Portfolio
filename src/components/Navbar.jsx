  ...
  return (
    <nav className="px-6 py-4  flex items-center justify-between bg-white dark:bg-gray-900 shadow-md max-w-6xl mx-auto px-6 py-20">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-2xl font-bold text-gray-900 dark:text-white">Pranav Panchwatkar</span>
      </div>

      {/* Navigation links (right side) */}
      <div className="space-x-4 hidden md:flex">
        <a href="#home" className="text-gray-600 dark:text-gray-300 hover:text-blue-600"></a>
        ...
        <a href="#contact" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">Services</a>
